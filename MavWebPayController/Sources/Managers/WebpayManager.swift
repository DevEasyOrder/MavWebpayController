...
public class WebpayManager {
    ...
    public func enrolleCard()->Promise<String>{
        return Promise<String>(work: {
            fulfill,reject in
            AF.request(URLsManager.Router.initInscription(params: nil)).responseJSON(completionHandler: {
                response in
    ...
    public func finishEnrollement()->Promise<[String : Any]>{
        return Promise<[String : Any]>(work: {
            fulfill,reject in
            AF.request(URLsManager.Router.finishInscription(params: nil)).responseJSON(completionHandler: {
                response in
    ...
    public func unsubscribeEnrollment()->Promise<Bool>{
        return Promise<Bool>(work: {
            fulfill, reject in
            AF.request(URLsManager.Router.unsubscribe(params: nil)).responseJSON(completionHandler: {
                response in
                guard response.error == nil else{
                    reject(response.error!)
                    return
    ...
    public func authorize()->Promise<[String : Any]>{
        return Promise<[String : Any]>(work: {
            ...
            AF.request("\(MavWebpayConfiguration.shared.baseURL)/authorize?\(queryParams)", method: .post, parameters: nil, headers: [
